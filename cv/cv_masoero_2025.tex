...
%\years{2020} 
\begin{itemize}
	\item ``\href{https://arxiv.org/abs/2506.12654}{{\textbf{Robust and efficient multiple-unit switchback experimentation}}''} (pre-print; Missault, \mm, Delb\'{e}, Richardson, Imbens)
