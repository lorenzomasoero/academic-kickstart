...
\begin{itemize}
    ...
    \small{
        \begin{itemize}
	    \item \href{https://arxiv.org/abs/2401.01264}{\color{blue}{Multiple Randomization Designs*}} (Accepted; JRSS-B (2026+))
...
%\years{2020} 
\begin{itemize}
	\item ``\textbf{Carryover detection in switchback experimentation}''; CauScien Workshop, NeurIPS 2025. (\href{https://openreview.net/pdf?id=fyfkP1TOKW}{Missault, \mm})
	\item ``\textbf{Optimizing duration of online experiments via Bayesian early termination}''; Code@MIT 2025. (\mm, Gualavisi)
	\item ``\textbf{Rethinking Power in Online Experimentation: Connecting Frequentist and Bayesian Approaches to Inform Experiment Design}''; Code@MIT 2025. (Gualavisi, Kessler, \mm)
